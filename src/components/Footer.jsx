  ...
  return (
    <div className="footer-section-bg">
      <div className="footer-section-container">
        ...
        <div>
          <ul>
            ...
            <li>
              <a href="/">Google From UI Enhancer</a>
            </li>
            <li>
      ...
      <p>
        Made with{" "}
        <img
          src="https://www.boloforms.com/_next/static/media/1f525.a7bd71d6.svg"
          width="36px"
          height="16px"
          alt="fire"
        />{" "}
        +{" "}
        <img
          src="https://www.boloforms.com/_next/static/media/2764.8838f014.svg"
          alt="heart"
          width="36px"
          height="16px"
        />{" "}
